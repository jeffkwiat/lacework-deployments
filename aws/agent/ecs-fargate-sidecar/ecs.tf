  ...
  container_definitions = jsonencode([
    ...
    },
    {
      ...
      "command" : [
        "/bin/sh",
        "-c",
        "/var/lib/lacework-backup/lacework-sidecar.sh && echo '<html> <head> <title>Amazon ECS Sample App</title> <style>body {margin-top: 40px; background-color: #333;} </style> </head><body> <div style=color:white;text-align:center> <h1>Amazon ECS Sample App</h1> <h2>Congratulations!</h2> <p>Your application is now running on a container in Amazon ECS.</p> </div></body></html>' >  /usr/local/apache2/htdocs/index.html && httpd-foreground"
      ],
      ...
      "environment" : [
        {
          ...
          "value" : "fbb16a0055db5bda0205453dbfbc51d7ec7ee84225e3f1f93bab41f6"
        }
      ],
      "resourceRequirements" : null,
      "ulimits" : null,
      ...
      "stopTimeout" : null,
      "image" : "jeffkwiat/fargate-app:latest", # "httpd:2.4",
      "startTimeout" : null,
